...
module Api::V0::Bindings
  class CreatedHighlightV1
    ...
    # client browser location when event occurred.
    ...
    def hash
      [client_clock_occurred_at, client_clock_sent_at, type, source_uri, session_uuid, session_order, highlight_id, source_type, source_id, source_metadata, annotation, anchor, color, location_strategies, scope_id].hash
    end
