...
module Api::V0::Bindings
  ...
  class InteractedElementV1SourceMetadata
    ...
    # Version that impacts the source content, but is not revision of the content itself, such as a versioned api, or content pipeline
    attr_accessor :context_version

    # Zero based index of this content in its parent list, if any exists.
    attr_accessor :content_index

    # ID for the larger scope of this content
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'context_version')
        self.context_version = attributes[:'context_version']
      end

      if attributes.has_key?(:'content_index')
    ...
    def list_invalid_properties
      ...
      if @content_version.nil?
        invalid_properties.push('invalid value for "content_version", content_version cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @content_version.nil?
      true
    end
    ...
    def hash
      [content_id, content_version, context_version, content_index, scope_id].hash
    end
